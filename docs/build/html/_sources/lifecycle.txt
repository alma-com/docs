...
Вывод блоков
-------------------------
Как уже говорилось выше блоки админстративной панели выводятся в файле ``\class\text_extended.p``. **В данном файле не рекомендуется что либо менять. Только позволительно подключать новые блоки.**
